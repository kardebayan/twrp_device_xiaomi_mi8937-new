...
BOARD_SUPER_PARTITION_GROUPS := tenor_dynpart
BOARD_TENOR_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_TENOR_DYNPART_PARTITION_LIST := $(ALL_PARTITIONS)
